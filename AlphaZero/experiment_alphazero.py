...
def test_vs_alphazero_player(
    ...
    alpha_player_1 = AlphaZero_player_heavyrollout(1, mcts_params, model2)
    alpha_player_2 = AlphaZero_player(2, mcts_params, model1)
    alpha_player_3 = AlphaZero_player_heavyrollout(3, mcts_params, model2)
...
def test_vs_rule_player_heavy(
    ...
    alpha_player_0 = AlphaZero_player_heavyrollout(0, mcts_params, model)
