...
from AlphaZero.AlphaZeroPlayer.alphazero_player_test import AlphaZero_player_test
...
def test_vs_alphazero_player(
    ...
    alpha_player_1 = AlphaZero_player_test(1, mcts_params, model2)
    alpha_player_2 = AlphaZero_player(2, mcts_params, model1)
    alpha_player_3 = AlphaZero_player_test(3, mcts_params, model2)
...
def test_vs_rule_player_test(
    ...
    alpha_player_0 = AlphaZero_player_test(0, mcts_params, model)
    alpha_player_2 = AlphaZero_player_test(2, mcts_params, model)
...
def run_test_multiprocess(
    ...
    elif opponent == "rule_test":
        test_function = test_vs_rule_player_test
    else:
