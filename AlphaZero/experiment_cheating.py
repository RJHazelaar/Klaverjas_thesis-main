...
def test_vs_alphazero_player(
    ...
    alpha_player_0 = AlphaZero_player_cheating(0, mcts_params, model1)
    alpha_player_1 = AlphaZero_player_heavyrollout_cheating(1, mcts_params, model2)
    alpha_player_2 = AlphaZero_player_cheating(2, mcts_params, model1)
    alpha_player_3 = AlphaZero_player_heavyrollout_cheating(3, mcts_params, model2)
...
def test_vs_rule_player(
    ...
    alpha_cheat_player_0 = AlphaZero_player_cheating(0, mcts_params, model)
    alpha_cheat_player_2 = AlphaZero_player_cheating(2, mcts_params, model)
