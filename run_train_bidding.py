...
from AlphaZero.train_alphazero_bidding import train
...
def main():
    ...
    bidding_model_name = "bidding_network"
    run_settings = {
        "project_name": "Thesis_test_bidding",
    ...
    selfplay_params = {
        ...
        "extra_noise_ratio": 0.0,  # when training extra_noise_ratio * mcts_steps is added to all visit counts
        "mcts_params": {
            "mcts_steps": 50,
            "n_of_sims": 0,
            "nn_scaler": 1,
