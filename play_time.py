...
def main():
    #Inlcude time_limit in params dictionary
    mcts_params = {
        "mcts_steps": 10,
        "n_of_sims": 1,
        "nn_scaler": 1,
    ...
    alpha_player_1 = AlphaZero_player(1, mcts_params, model, time_limit=2000)
    #alpha_player_2 = AlphaZero_player(2, mcts_params, model)
    alpha_player_2 = AlphaZero_player_heavyrollout(2, mcts_params, model, time_limit=2000)
